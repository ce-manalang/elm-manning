...
var $author$project$PhotoGallery$initialModel = {activity: '', chosenSize: $author$project$PhotoGallery$Medium, hue: 2, noise: 2, ripple: 2, status: $author$project$PhotoGallery$Loading};
var $author$project$PhotoGallery$init = function (version) {
...
var $author$project$PhotoGallery$urlPrefix = 'http://elm-in-action.com/large/';
var $author$project$PhotoGallery$applyFilters = function (model) {
	var _v0 = model.status;
	switch (_v0.$) {
		case 'Loaded':
			var selectedUrl = _v0.b;
			var url = _Utils_ap($author$project$PhotoGallery$urlPrefix, selectedUrl);
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						status: A2($author$project$PhotoGallery$selectUrl, selectedUrl, model.status)
					}),
			...
			case 'ClickPhoto':
				...
				return $author$project$PhotoGallery$applyFilters(
					_Utils_update(
						model,
						{
							status: A2($author$project$PhotoGallery$selectUrl, img, model.status)
						}));
			case 'ClickSuprise':
					...
					if (msg.a.a.b) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									status: $author$project$PhotoGallery$Errored('Server didn\'t return any photos?')
								}),
							$elm$core$Platform$Cmd$none);
					}
				} else {
...
var $author$project$PhotoFolders$ClickPhoto = function (a) {
	return {$: 'ClickPhoto', a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$PhotoFolders$ClickPhoto(url))
			]),
		_List_fromArray(
			[
...
var $author$project$PhotoFolders$viewRelatedPhoto = function (name) {
	var url = $author$project$PhotoFolders$urlPrefix + ('photos/' + (name + '/thumb'));
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				$elm$html$Html$Events$onClick(
				$author$project$PhotoFolders$ClickPhoto(name))
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$PhotoGallery$ClickSuprise = {$: 'ClickSuprise'};
var $author$project$PhotoGallery$GotSlidHue = function (a) {
	return {$: 'GotSlidHue', a: a};
};
var $author$project$PhotoGallery$GotSlidNoise = function (a) {
	return {$: 'GotSlidNoise', a: a};
};
var $author$project$PhotoGallery$GotSlidRipple = function (a) {
	return {$: 'GotSlidRipple', a: a};
};
...
var $author$project$PhotoGallery$rangeSlider = $elm$html$Html$node('range-slider');
...
var $author$project$PhotoGallery$ChooseSize = function (a) {
					...
					_Utils_ap(
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onClick(
								$author$project$PhotoGallery$ChooseSize(size))
							]),
						_Utils_eq(selectedSize, size) ? _List_fromArray(
							[
...
var $author$project$PhotoGallery$ClickPhoto = function (a) {
	return {$: 'ClickPhoto', a: a};
};
...
var $author$project$PhotoGallery$viewThumbnail = F2(
	function (selectedUrl, thumb) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$src('http://elm-in-action.com/' + thumb.url),
					...
					$elm$html$Html$Events$onClick(
					$author$project$PhotoGallery$ClickPhoto(thumb.url))
				]),
			_List_Nil);
	});
	...
	function (photos, selectedUrl, model) {
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$PhotoGallery$ClickSuprise)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						A3($author$project$PhotoGallery$viewFilter, $author$project$PhotoGallery$GotSlidHue, 'Hue', model.hue),
						A3($author$project$PhotoGallery$viewFilter, $author$project$PhotoGallery$GotSlidRipple, 'Ripple', model.ripple),
						A3($author$project$PhotoGallery$viewFilter, $author$project$PhotoGallery$GotSlidNoise, 'Noise', model.noise)
					])),
				A2(
				$elm$html$Html$h3,
				_List_Nil,
